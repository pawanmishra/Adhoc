...
public class Graph
{
	...
	public Graph(int vertexCount)
	{
		...
		_connectedComponents = new int[vertexCount];
	...
	public int NumberOfComponents {get { return _count; }}
	
	public bool Connected(int source, int target) { return _connectedComponents[source] == _connectedComponents[target]; }
	
	public void Dfs(int source)
	{
		_visited[source] = true;
		_connectedComponents[source] = _count;
