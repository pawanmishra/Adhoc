...
void Main()
{
	...
	n21.Left = new Node(9);
	n21.Left.Left = new Node(5);
	n21.Left.Right = new Node(12);
	n21.Left.Right.Right = new Node(15);
	n21.Right = new Node(49);
	n21.Right.Left = new Node(23);
	n21.Right.Right = new Node(52);
	n21.Right.Right.Left = new Node(50);
	
	IsIdentical(n20, n21).Dump();
}
...
public static bool IsIdentical(Node n1, Node n2)
{
